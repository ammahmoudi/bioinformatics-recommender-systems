...
const aliases: Record<string, string> = {
  ...
  'Graph Convolution': 'Graph Convolution / Message Passing',
  'Message Passing': 'Graph Convolution / Message Passing',
  'message passing': 'Graph Convolution / Message Passing',
  'adjacency matrix': 'Adjacency Matrix (A)',
  'self-looped adjacency matrix': 'Self-Looped Adjacency (A + I)',
  'node feature matrix': 'Node Feature Matrix (H)',
  'degree matrix': 'Degree Matrix (D)',
