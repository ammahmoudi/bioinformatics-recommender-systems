...
export function methodConcreteNodes(method: MethodSlide, domain: 'movie' | 'bio'): FlowNode[] {
  const movie: Record<string, FlowNode[]> = {
    ...
    cbf: [
      ...
      { title: 'TF-IDF vector', detail: 'Feature weights', icon: Binary, media: 'matrix', visual: 'tfidf-vector', tone: 'blue' },
      { title: 'Profile match', detail: 'Cosine similarity', icon: Sigma, media: 'matrix', visual: 'cosine-score', tone: 'cyan' },
    ...
    autoencoder: [
      { title: 'User profile', detail: 'Noisy watch vector', icon: UserRound, media: 'matrix', visual: 'noisy-profile', tone: 'rose' },
      { title: 'Encoder', detail: 'Compress taste', icon: BrainCircuit, media: 'matrix', visual: 'encoder', tone: 'cyan' },
      { title: 'Taste code', detail: 'Latent vector', icon: Database, media: 'matrix', visual: 'bottleneck', tone: 'violet' },
      { title: 'Decoder', detail: 'Fill missing ratings', icon: Sparkles, media: 'matrix', visual: 'decoder', tone: 'amber' }
    ],
    gnn: [
      { title: 'Inception node', detail: 'Movie embedding', icon: Film, media: 'poster', tone: 'violet' },
      { title: 'Actor messages', detail: 'Neighbor information', icon: UserRound, media: 'matrix', visual: 'actor-message', tone: 'rose' },
      { title: 'Director messages', detail: 'More graph context', icon: Clapperboard, media: 'matrix', visual: 'director-message', tone: 'blue' },
      { title: 'Updated vector', detail: 'Recommend neighbors', icon: GitBranch, media: 'matrix', visual: 'latent-space', tone: 'cyan' }
    ],
    rl: [
      { title: 'Show Inception', detail: 'Action', icon: Film, media: 'poster', tone: 'violet' },
      { title: '40 min watched', detail: 'Environment response', icon: Eye, media: 'reward', visual: 'watch-reward', tone: 'cyan' },
      { title: 'Positive reward', detail: 'Engagement signal', icon: Star, media: 'reward', visual: 'watch-reward', tone: 'amber' },
      { title: 'More sci-fi', detail: 'Policy update', icon: Route, media: 'matrix', visual: 'policy-update', tone: 'blue' }
    ]
  };
  ...
  const bio: Record<string, FlowNode[]> = {
    ...
    cbf: [
      ...
      { title: 'Same target', detail: 'High Tanimoto', icon: Target, media: 'matrix', visual: 'target-transfer', tone: 'amber' }
    ],
    graph: [
    ...
    autoencoder: [
      ...
      { title: 'Denoise', detail: 'Mask/corrupt input', icon: BrainCircuit, media: 'matrix', visual: 'encoder', tone: 'cyan' },
      { title: 'Cell-state code', detail: 'Latent vector', icon: Database, media: 'matrix', visual: 'bottleneck', tone: 'violet' },
      { title: 'Complete profile', detail: 'Missing associations', icon: Sparkles, media: 'matrix', visual: 'reconstruction', tone: 'amber' }
    ],
    gnn: [
      { title: 'Molecular graph', detail: 'Atoms are nodes', icon: Atom, media: 'molecule', visual: 'molecular-graph', tone: 'mint' },
      { title: 'Bond messages', detail: 'Edges pass context', icon: GitBranch, media: 'matrix', visual: 'bond-message', tone: 'cyan' },
      { title: 'Drug embedding', detail: 'Global pooling', icon: Database, media: 'matrix', visual: 'graph-pooling', tone: 'violet' },
    ...
    rl: [
      ...
      { title: 'Improve policy', detail: 'Keep better actions', icon: RefreshCw, media: 'matrix', visual: 'policy-update', tone: 'blue' }
    ]
  };
...
export function methodAlgorithmNodes(method: MethodSlide, domain: 'movie' | 'bio'): FlowNode[] {
  const commonMovie: Record<string, FlowNode[]> = {
    cf: [
      ...
      { title: 'Latent vectors', detail: 'User and movie codes', icon: Database, media: 'matrix', visual: 'latent-space', tone: 'blue' },
      { title: 'Dot product', detail: 'Predicted rating', icon: Calculator, media: 'reward', visual: 'watch-reward', tone: 'amber' }
    ],
    cbf: [
      { title: 'Movie profile', detail: 'Genre, director, keywords', icon: Clapperboard, media: 'matrix', visual: 'movie-profile', tone: 'violet' },
      { title: 'TF-IDF', detail: 'Weighted text vector', icon: Binary, media: 'matrix', visual: 'tfidf-vector', tone: 'blue' },
      { title: 'Cosine score', detail: 'Compare profiles', icon: Sigma, media: 'matrix', visual: 'cosine-score', tone: 'cyan' },
      { title: 'Rank similar', detail: 'Recommend nearest items', icon: Star, media: 'reward', visual: 'watch-reward', tone: 'amber' }
    ],
    graph: [
      { title: 'Node graph', detail: 'User, movie, actor', icon: Network, media: 'matrix', visual: 'node-graph', tone: 'cyan' },
      { title: 'Walk paths', detail: 'Move through edges', icon: Route, media: 'matrix', visual: 'walk-path', tone: 'rose' },
      { title: 'Proximity', detail: 'Short paths score high', icon: Waypoints, media: 'matrix', visual: 'similarity-score', tone: 'blue' },
      { title: 'Recommend', detail: 'Rank high nodes', icon: Star, media: 'reward', visual: 'watch-reward', tone: 'amber' }
    ],
    autoencoder: [
      { title: 'Noisy profile', detail: 'Masked watch vector', icon: UserRound, media: 'matrix', visual: 'noisy-profile', tone: 'rose' },
      { title: 'Encoder NN', detail: 'Compress signals', icon: BrainCircuit, media: 'matrix', visual: 'encoder', tone: 'cyan' },
      { title: 'Bottleneck', detail: 'Latent taste code', icon: Database, media: 'matrix', visual: 'bottleneck', tone: 'violet' },
      { title: 'Decoder NN', detail: 'Reconstruct ratings', icon: Sparkles, media: 'matrix', visual: 'decoder', tone: 'amber' }
    ],
    gnn: [
      { title: 'Graph features', detail: 'Movie and neighbor vectors', icon: Network, media: 'matrix', visual: 'adjacency', tone: 'cyan' },
      { title: 'Pass messages', detail: 'Actors/directors to movie', icon: GitBranch, media: 'matrix', visual: 'actor-message', tone: 'rose' },
      { title: 'Aggregate', detail: 'Update embedding', icon: Layers3, media: 'matrix', visual: 'graph-pooling', tone: 'violet' },
      { title: 'Recommend', detail: 'Use graph-neighbor vectors', icon: Star, media: 'reward', visual: 'watch-reward', tone: 'amber' }
    ],
    rl: [
      { title: 'Agent', detail: 'Recommender policy', icon: Bot, media: 'matrix', visual: 'agent-policy', tone: 'cyan' },
      { title: 'Action', detail: 'Show movie', icon: Film, media: 'matrix', visual: 'action-step', tone: 'violet' },
      { title: 'Reward', detail: 'Watch time', icon: Star, media: 'reward', visual: 'watch-reward', tone: 'amber' },
      { title: 'Update', detail: 'Maximize long-term value', icon: RefreshCw, media: 'matrix', visual: 'policy-update', tone: 'blue' }
    ]
  };
  ...
  const commonBio: Record<string, FlowNode[]> = {
    cf: [
      ...
      { title: 'Latent spaces', detail: 'Drug and protein vectors', icon: Database, media: 'matrix', visual: 'latent-space', tone: 'blue' },
    ...
    cbf: [
      ...
      { title: 'Tanimoto', detail: 'Shared bits / union bits', icon: Sigma, media: 'matrix', visual: 'tanimoto-score', tone: 'cyan' },
      { title: 'Target transfer', detail: 'Suggest same target', icon: Target, media: 'matrix', visual: 'target-transfer', tone: 'amber' }
    ],
    graph: [
      { title: 'Hetero graph', detail: 'Drug, disease, gene, protein', icon: Network, media: 'matrix', visual: 'node-graph', tone: 'mint' },
      { title: 'RWR', detail: 'Walk plus restart', icon: Route, media: 'matrix', visual: 'rwr-restart', tone: 'cyan' },
    ...
    autoencoder: [
      ...
      { title: 'Denoising AE', detail: 'Learns robust structure', icon: BrainCircuit, media: 'matrix', visual: 'encoder', tone: 'cyan' },
      { title: 'Latent state', detail: 'Compact cell/patient vector', icon: Database, media: 'matrix', visual: 'bottleneck', tone: 'violet' },
      { title: 'Reconstruct', detail: 'Predict missing values', icon: Sparkles, media: 'matrix', visual: 'reconstruction', tone: 'amber' }
    ],
    gnn: [
      { title: 'A + I', detail: 'Self-looped adjacency', icon: Table2, media: 'matrix', visual: 'adjacency', tone: 'cyan' },
      { title: 'H features', detail: 'Atom/protein node features', icon: Atom, media: 'matrix', visual: 'node-feature-matrix', tone: 'mint' },
    ...
    rl: [
      ...
      { title: 'Policy', detail: 'Generate better molecules', icon: RefreshCw, media: 'matrix', visual: 'policy-update', tone: 'blue' }
    ]
  };
