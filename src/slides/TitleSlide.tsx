  ...
  return (
    <div className="titleSlide slidePage">
      <div className="titleCopy">
        ...
        <p>By Amirhossein Mahmoudi. A synchronized Vite presentation with custom rich diagrams, KaTeX math, appendix drawers, algorithm chips, and method-by-method pagination.</p>
